...
<a id="license"></a>
## License
This is the code for SunFounder Raspad 3.
...
raspad 3 comes with ABSOLUTELY NO WARRANTY; for details run ./show w. This is free software, and you are welcome to redistribute it under certain conditions; run ./show c for details.

SunFounder, Inc., hereby disclaims all copyright interest in the program 'raspad3' (which makes passes at compilers).
